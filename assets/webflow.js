...
!function(t) {
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = E, e.replaceAt = g, e.getIn = _, e.set = m, e.setIn = y, e.update = I, e.updateIn = b, e.merge = T, e.mergeDeep = w, e.mergeIn = O, e.omit = A, e.addDefaults = x;
    /*!
 * Timm
 *
 ...
 */
    ...
    t.exports = function(t, e, n, c, s, f) {
        ...
        for (f.set(t, e), f.set(e, t); ++E < d;) {
            var m = t[E],
                y = e[E];
            if (c)
                var I = l ? c(y, m, E, e, t, f) : c(m, y, E, t, e, f);
            if (void 0 !== I) {
                if (I)
                    continue;
                g = !1;
    ...
    function at(t) {
        ...
        e.active && (e.eventListeners.forEach(ut), t.dispatch((0, y.sessionStopped)()))
    }
    function ut(t) {
        var e = t.target,
            n = t.listenerParams;
    ...
    function Et(t) {
        ...
        if (!y || !y.length)
            return !1;
        c >= y.length && (0, s.default)(h, "config.loop") && (c = 0), 0 === c && b && c++;
    ...
    function gt(t) {
        ...
        e.dispatch((0, y.instanceAdded)((0, a.default)({
            ...
            t.dispatch((0, y.instanceStarted)(e, 0)), t.dispatch((0, y.animationFrameChanged)(performance.now(), n)), yt(t.getState().ixInstances[e], t)
        }(e, l) : (D({
            store: e,
            select: function(t) {
    ...
    n(121), n(123), n(37), n(125), n(315), n(316), n(317), n(318), n(323), n(324), t.exports = n(325)
}, function(t, e, n) {
    "use strict";
    var r = n(4);
 ...
 */
            ...
            return function(t, e, n, r, i, o) {
                ...
                case ct:
                    var g = dt[u],
                        ...
                        I = n.aValue;
                    Nt(t, g, o), a(t, g, I >= 1 ? "rgb(".concat(_, ",").concat(m, ",").concat(y, ")") : "rgba(".concat(_, ",").concat(m, ",").concat(y, ",").concat(I, ")"));
                    break;
                default:
                    var b = c.unit,
                        T = void 0 === b ? "" : b;
    ...
    function mt(t) {
        ...
        var A,
            ...
            C = n && u(_t(n.target));
        if (N ? (A = R.limitAffectedElements, x = C, S = u(R)) : x = S = u({
            id: _,
            selector: I,
            selectorGuids: b
        }), n && w) {
        ...
        return null == x || null == S ? [] : m.IS_BROWSER_ENV && i ? c(S).filter(function(t) {
            return i.contains(t)
        }) : A === k ? c(x, S) : A === X ? s(c(x)).filter(l(S)) : A === G ? f(c(x)).filter(l(S)) : c(S)
    }
    var yt = /px/,
        It = function(t, e) {
        ...
        b = function(t, e) {
            ...
            for (var O = 0, A = i.length; O < A; O++) {
                ...
                if (0 === O && (E = R[0]), w >= S) {
                    ...
                    var N = i[O + 1],
                        C = N && w !== S;
                    g = C ? N.actionItems[0] : null, C && (_ = S / 100, y = (N.keyframe - S) / 100)
                }
            }
            var L = {};
            if (E && !g)
                ...
                for (var j = (T - _) / y, F = E.config.easing, k = h(F, j, f), X = 0, G = a.length; X < G; X++) {
                    var U = a[X],
                        V = m(s, U, E.config),
                        W = (m(s, U, g.config) - V) * k + V;
                    L[U] = W
                }
            return (0, o.merge)(t, {
                position: T,
    ...
    t.exports = function(t, e, n) {
        ...
        function T() {
            ...
            if (s = arguments, f = this, v = t, n) {
                ...
                if (g)
                    return clearTimeout(p), p = setTimeout(I, e), m(v)
            }
    ...
    var c,
        ...
        gt = (r = {}, (0, o.default)(r, S, vt()), (0, o.default)(r, R, ht()), (0, o.default)(r, x, vt()), (0, o.default)(r, A, ht()), (0, o.default)(r, D, vt(!1)), (0, o.default)(r, L, ht(!1)), (0, o.default)(r, N, vt()), (0, o.default)(r, C, ht()), (0, o.default)(r, V, {
            ...
            handler: function(t) {
                ...
                return w && (O > .95 || O < .05) && (O = Math.round(O)), (u !== h.EventBasedOn.ELEMENT || x || x !== a.elementHovered) && (O = f ? 1 - O : O, e.dispatch((0, g.parameterChanged)(A, O))), {
                    elementHovered: x,
                    clientX: v,
                    clientY: _,
                    pageX: y,
                ...
                !function(e, n) {
                    ...
                    if (g)
                        ...
                        h.on("click", function() {
                            ...
                            (r = i.target && i.target.files && i.target.files[0]) && (o.toggle(!1), s.toggle(!1), a.toggle(!0), E.text(r.name), x() || b(n), n.fileUploads[e].uploading = !0, function(e, n) {
                                var r = {
                                    name: e.name,
                                    size: e.size
                                };
    ...
    r.define("slider", t.exports = function(t, e) {
        ...
        function L(e, n) {
            ...
            var d = e.offsetX || 0,
                ...
                T = "opacity " + I + "ms " + y,
                w = "transform " + I + "ms " + y;
            if (h.find(a).removeAttr("tabindex"), h.removeAttr("aria-hidden"), h.find("*").removeAttr("aria-hidden"), _.find(a).attr("tabindex", "-1"), _.attr("aria-hidden", "true"), _.find("*").attr("aria-hidden", "true"), u || (h.each(g.intro), _.each(g.outro)), n.immediate && !s)
            ...
            if (e.index !== e.previous) {
                if (e.ariaLiveLabel.text("Slide ".concat(o + 1, " of ").concat(i.length, ".")), "cross" === m) {
                    var O = Math.round(I - I * r.crossOver),
                        A = Math.round(I - O);
                    return T = "opacity " + O + "ms " + y, l(E).set({
                        visibility: ""
                    }).add(T).start({
                        opacity: 0
                    }), void l(h).set({
...
Webflow.require('ix2').init(
{
    "events": {
        ...
        "e-5": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5f9129a1428075f95c1a5c2a|14ce0c0d-efc5-034c-2c64-1510455e3a35"
            },
            "targets": [],
            "config": {
                "loop": false,
        ...
        "e-7": {
            ...
            "target": {
                ...
                "originalId": "5f9129a1428075f95c1a5c2a|14ce0c0d-efc5-034c-2c64-1510455e3a79",
                "appliesTo": "CLASS"
            },
            "targets": [],
            "config": {
        ...
        "e-15": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5f8aa4e85eb3860b2d19d922|698d3d43-6182-d5a1-a3d1-e1c633d150ad"
            },
            "targets": [],
            "config": {
                "loop": true,
        ...
        "e-17": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5f8aa4e85eb3860b2d19d922|c5082894-3d57-473a-2d5f-32f6c14cf6fd"
            },
            "targets": [],
            "config": {
                "loop": true,
    ...
    "actionLists": {
        "a": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "value": "flex",
                        "target": {
                            "id": "5f8aa4e85eb3860b2d19d922|e0bc2f96-dd7f-2c7c-322e-47c5751ad5fc"
                        }
                    }
                }]
            }, {
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5f8aa4e85eb3860b2d19d922|e0bc2f96-dd7f-2c7c-322e-47c5751ad5fd"
                        },
                        "xValue": 1,
                        "yValue": 1,
                        "locked": true
            ...
            "createdOn": 1603104258637,
            "useFirstGroupAsInitialState": true
        },
        "a-2": {
            "id": "a-2",
            "title": "stickyBuyBarOut",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-2-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "target": {
                            "selector": ".stickybuy",
                            "selectorGuids": ["c08565b0-30df-a1c6-f4f0-4acdcfca9e2e"]
                        },
                        "yValue": 200,
                        "xUnit": "PX",
                        "yUnit": "PX",
            ...
            "createdOn": 1596373016363,
            "useFirstGroupAsInitialState": false
        },
        "a-3": {
            "id": "a-3",
            "title": "stickyBuyBarIn",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-3-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["ac2fd045-b80f-9118-436c-242b6278b0b3"]
                        },
                        "heightValue": 0,
                        "widthUnit": "PX",
                        "heightUnit": "PX"
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".image-56",
                            "selectorGuids": ["ac2fd045-b80f-9118-436c-242b6278b09b"]
                        },
                        "zValue": 0,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
        ...
        "a-9": {
            ...
            "createdOn": 1603353533557,
            "useFirstGroupAsInitialState": false
        },
        "a-8": {
            "id": "a-8",
            "title": "cloud2-floating",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-8-n",
                    "actionTypeId": "TRANSFORM_MOVE",
